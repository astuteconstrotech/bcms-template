...
if (jQuery("#apex-radialbar-chart").length) {
  options = {
      ...
      colors: ["#f16a1b", "#c03221", "#876cfe", "#1aa053"]
  };
  if(typeof ApexCharts !== undefined){
...
if (jQuery("#apex-pie-chart").length) {
  options = {
      ...
      colors: ["#f16a1b", "#c03221", "#876cfe", "#1aa053", "#c8c8c8"],
      legend: {
          position: "bottom"
      }
  };
