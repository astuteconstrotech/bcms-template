                ...
                <ul class="navbar-nav iq-main-menu">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-special" data-bs-parent="#sidebar">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="../../dashboard/special-pages/pricing">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="#ff5e00">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="#ff5e00"></circle>
                           ...
                           <tbody>
                              <tr>
                                 ...
                                 <td class="text-center child-cell">
                                    <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       <path  d="M23 7L6.44526 17.8042C5.85082 18.1921 5.0648 17.9848 4.72059 17.3493L1 10.4798" stroke="#ff5e00" stroke-width="2" stroke-linecap="round"/>
                                    </svg>
                                 </td>
                              ...
                              <tr>
                                 ...
                                 <td class="text-center child-cell">
                                    <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M4 20L20 4M20 20L4 4" stroke="#ff5e00" stroke-width="2" stroke-linecap="round"/>
                                    </svg>
                                 </td>
                                 <td class="text-center child-cell active">
                                    <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <table class="table table-bordered mb-0">
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td class="text-center">
                                    <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       <rect x="6" y="11" width="12" height="2" rx="1" fill="#ff5e00"/>
                                    </svg>
                                 </td>
                                 <td class="text-center active">
                                    <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <tr>
                                 ...
                                 <td class="text-center">
                                    <svg width="20" viewBox="0 0 24 24" fill="none" stroke="#ff5e00" xmlns="http://www.w3.org/2000/svg">
                                       <rect x="6" y="11" width="12" height="2" rx="1" fill="#ff5e00"/>
                                    </svg>
                                 </td>
                                 <td class="text-center active">
                              ...
                              <tr>
                                 ...
                                 <td class="text-center">
                                     <svg width="20" viewBox="0 0 24 24" fill="none" stroke="#ff5e00" xmlns="http://www.w3.org/2000/svg">
                                       <rect x="6" y="11" width="12" height="2" rx="1" fill="#ff5e00" stroke="#ff5e00"/>
                                    </svg>
                                 </td>
                                 <td class="text-center active">
                                    <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
