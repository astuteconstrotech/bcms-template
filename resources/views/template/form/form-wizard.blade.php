                ...
                <ul class="navbar-nav iq-main-menu">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-form" data-bs-parent="#sidebar">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="../../dashboard/form/form-wizard">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="#ff5e00">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="#ff5e00"></circle>
                        ...
                        <form id="form-wizard1" class="text-center mt-3">
                            <ul id="top-tab-list" class="p-0 row list-inline">
                                <li class="col-lg-3 col-md-6 text-start mb-2 active" id="account">
                                    <a href="javascript:void();">
                                        <div class="iq-icon me-3">
                                            <svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="20" width="20" fill="none" viewBox="0 0 24 24" stroke="#ff5e00">
                                ...
                                <li id="personal" class="col-lg-3 col-md-6 mb-2 text-start">
                                    <a href="javascript:void();">
                                        <div class="iq-icon me-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" height="20" width="20" fill="none" viewBox="0 0 24 24" stroke="#ff5e00">
