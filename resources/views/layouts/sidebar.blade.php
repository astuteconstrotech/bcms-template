                ...
                <ul class="navbar-nav iq-main-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#leads-management" role="button" aria-expanded="false" aria-controls="leads-management">
                            <span class="item-name"> <i class="fa fa-cog fa-fw fa-md" aria-hidden="true"></i> Lead Management</span>
                            <i class="right-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                                </svg>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="{{ url('activity')}}" target="_blank">
                            <span><i class="fa fa-pie-chart fa-fw fa-md" aria-hidden="true"></i> Activity</span>
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="{{ url('file-manager')}}" target="_blank">
                            <span><i class="fa fa-print fa-fw fa-md" aria-hidden="true"></i> Files</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="{{ url('Profile/index-dual-compact')}}" target="_blank">
                            <span><i class="fa fa-building-o fa-fw fa-md" aria-hidden="true"></i> Company Profile</span>
                        </a>
                    </li>
