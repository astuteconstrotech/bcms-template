            ...
            <div class="col-md-6">               
                           ...
                           <p class="text-center">Register and Join your organization with us</p>
                            ...
                            @endif                           
                               ...
                               <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="email" type="email" class=" form-control  border-default @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">
                            ...
                            <div class="form-group row">
                                <div class="col-md-6">
                                    ...
                                    <input id="password" type="password" class=" form-control  border-default @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="password-confirm" type="password" class=" form-control  border-default" name="password_confirmation" required autocomplete="new-password">
                                </div>
                            </div>
                            <div class="form-group row">
               ...
               <div class="sign-bg sign-bg-right">
                  <svg width="280" height="230" viewBox="0 0 421 359" fill="none" xmlns="http://www.w3.org/2000/svg">
                     <g opacity="0.05">
                        <rect x="-15.0845" y="154.773" width="543" height="77.5714" rx="38.7857" transform="rotate(-45 -15.0845 154.773)" fill="#f16a1b"/>
                        <rect x="149.47" y="319.328" width="543" height="77.5714" rx="38.7857" transform="rotate(-45 149.47 319.328)" fill="#f16a1b"/>
                        <rect x="203.936" y="99.543" width="310.286" height="77.5714" rx="38.7857" transform="rotate(45 203.936 99.543)" fill="#f16a1b"/>
                        <rect x="204.316" y="-229.172" width="543" height="77.5714" rx="38.7857" transform="rotate(45 204.316 -229.172)" fill="#f16a1b"/>
                     </g>
                  </svg>
               </div>
            </div>   
