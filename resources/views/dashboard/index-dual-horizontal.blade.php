    ...
    <main class="main-content">
      ...
      <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
        ...
        <button data-trigger="navbar_main" class="d-xl-none btn  btn-primary rounded-pill p-1 pt-0" type="button">
                       <svg width="20px" height="20px" viewBox="0 0 24 24">
                          <path fill="#ff5e00" d="M4,11V13H16L10.5,18.5L11.92,19.92L19.84,12L11.92,4.08L10.5,5.5L16,11H4Z"></path>
                      </svg>
          </button>
          <a href="../dashboard/index" class="logo-center navbar-brand col-md-3 col-lg-3">
              <!--Logo start-->
      ...
      <div class="navbar dual-horizontal">
        ...
        <div class="container-fluid">
           ...
           <ul class="navbar-nav">
              <li class="nav-item"><a class="nav-link " href="../dashboard/index-horizontal"> Horizontal </a></li>
              <li class="nav-item"><a class="nav-link active" href="../dashboard/index-dual-horizontal"> Dual Horizontal </a></li>
              <li class="nav-item"><a class="nav-link " href="../dashboard/index-dual-compact"><span class="item-name">Dual Compact</span></a></li>
              <li class="nav-item"><a class="nav-link " href="../dashboard/index-boxed"> Boxed Horizontal </a></li>
              <li class="nav-item"><a class="nav-link " href="../dashboard/index-boxed-fancy"> Boxed Fancy</a></li>
           </ul>
        </div> <!-- container-fluid.// -->
        </nav>
